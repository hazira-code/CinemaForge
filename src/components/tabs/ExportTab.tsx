...
import { Download, FileText, Code, FileSpreadsheet, Check, Share2, Package } from 'lucide-react';
import { MovieProject } from '../../types';
import { downloadPDF, downloadMarkdown, downloadJSON } from '../../utils/exporter';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-panel p-6 rounded-3xl border border-blue-500/30 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Download Complete Pre-Production Packages in Industry Standard Formats</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-slate-800 hover:border-blue-500/40 transition-all space-y-4">
        ...
        <div className="glass-panel p-6 rounded-3xl border border-slate-800 hover:border-purple-500/40 transition-all space-y-4">
        ...
        {/* Full JSON Export */}
        <div className="glass-panel p-6 rounded-3xl border border-slate-800 hover:border-pink-500/40 transition-all space-y-4">
